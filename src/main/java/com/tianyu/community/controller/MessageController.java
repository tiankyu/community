...
import com.tianyu.community.service.MessageService;
...
public class MessageController implements CommunityConstant {
    ...
    public String getNoticeList(Model model){
        ...
        //查询评论类通知
        Message message = messageService.findLastedNotices(user.getId(), TOPIC_COMMENT);
        ...
        //查询点赞类通知
        message = messageService.findLastedNotices(user.getId(), TOPIC_LIKE);
        ...
        //查询关注类通知
        message = messageService.findLastedNotices(user.getId(), TOPIC_FOLLOW);
        messageVo = new HashMap<>();
        if (message != null) {
            messageVo.put("message", message);
